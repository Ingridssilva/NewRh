...
def primeiro_acesso():
    ...
    try:
        ...
        try:
            ...
            subject = "🔑 Crie sua senha — Portal de Carreiras Empresa Exemplo"
            content = (
                ...
                f'Clique no botão abaixo para criar sua senha e acessar o Portal de Carreiras da Empresa Exemplo. '
