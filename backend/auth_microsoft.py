...
BASE_URL      = os.getenv("BASE_URL", "https://carreiras.empresaexemplo.com.br")

# ── Lista de acesso autorizado ────────────────────────────────
# ROLE_OWNER  → Diretoria (aprovação final de vagas)
...
#
# Em produção, o ideal é carregar esta lista de uma tabela no banco de dados
# ou de uma variável de ambiente, em vez de mantê-la hardcoded no código.

GESTORES = {
    "admin1@empresaexemplo.com.br": "ROLE_ADMIN",
    "admin2@empresaexemplo.com.br": "ROLE_ADMIN",
    "owner@empresaexemplo.com.br":  "ROLE_OWNER",
}

EQUIPE_DP_RH = {
    "rh1@empresaexemplo.com.br": "ROLE_VIEWER",
    "rh2@empresaexemplo.com.br": "ROLE_VIEWER",
    "rh3@empresaexemplo.com.br": "ROLE_VIEWER",
}

EQUIPE_TI = {
    "ti@empresaexemplo.com.br": "ROLE_ADMIN",
}

# ROLE_GESTOR → Gerentes/supervisores que podem APENAS solicitar abertura de vagas
# A solicitação vai para aprovação da diretoria normalmente
GESTORES_CAMPO = {
    "gestor1@empresaexemplo.com.br": "ROLE_GESTOR",
    "gestor2@empresaexemplo.com.br": "ROLE_GESTOR",
}
