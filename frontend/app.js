/**
 * Empresa Exemplo — Portal de Carreiras
 */
...
// Lista de e-mails com acesso ao painel de gestor (deve espelhar as listas do backend em auth_microsoft.py)
const EMAILS_GESTOR = ["admin1@empresaexemplo.com.br", "admin2@empresaexemplo.com.br", "owner@empresaexemplo.com.br", "rh1@empresaexemplo.com.br", "rh2@empresaexemplo.com.br", "rh3@empresaexemplo.com.br", "ti@empresaexemplo.com.br", "gestor1@empresaexemplo.com.br", "gestor2@empresaexemplo.com.br"];
...
const Manager = {
  ...
  async inviteUser() {
    ...
    if (!email.endsWith('@empresaexemplo.com.br')) {
      showAlert('register-alert', '❌ Apenas e-mails @empresaexemplo.com.br são permitidos.');
      return;
    }
    try {
  ...
  async loadBancoTalentos() {
    ...
    try {
      const tkn = sessionToken || localStorage.getItem('auth_token');
      ...
      document.getElementById('modal-candidate-body').innerHTML = `
        ...
        <div id="print-profile-${app.id}" class="print-profile">
          <div class="print-header">
            <div class="print-header__title">Ficha do Candidato — Empresa Exemplo</div>
...
// Solicitar vaga (envia para aprovação da diretoria)
